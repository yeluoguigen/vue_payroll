  ...
  <div class="enterpriseSet">
    <div class>
      ...
      <div class="handle-box">
        ...
        <div class="enterpriseSerchList">
          <div class="enterpriseSerchList1">
            ...
            <el-button type="primary" icon="search" @click="searchUser">提交</el-button>
          </div>
        </div>  
        <div class="enterpriseSerchBtn">
      ...
      <el-table :data="tableData" border>
        <el-table-column fixed label="工号" prop="staff_id" align="center"></el-table-column>
        ...
        <el-table-column label="操作" width="200px" align="center">
          <template slot-scope="scope">
            <el-button type="text" @click="editUser(scope.$index, scope.row)" size="small">修改</el-button>
    ...
    <el-dialog :inline="true" title="新增" :visible.sync="dialogFormVisible">
      <el-form :inline="true" v-model="ruleFormAdd">
        ...
        <el-form-item :required="true" label="部门" :label-width="formLabelWidth">
    ...
    <el-dialog title="修改" :visible.sync="editFormVisible">
      <el-form v-model="editForm" ref="editForm">
...
export default {
  ...
  methods: {
    ...
    saveEditUser() {
      // this.editForm.baseSalary = this.editForm.CNY_USD === 'USD' ? '$'+ this.editForm.basic_salary : '￥'+ this.editForm.basic_salary
      var data = {
        id: this.editForm.id,
...
@media (min-width: 768px) {
  .enterpriseSet .enterpriseSerchList {
    width: 81%;
  }
} /*>=768的设备*/
